...
static const AFMMETRICS metrics[228] =
{
    ...
    {  38, 0x0026,  592, GN_ampersand },
    { 169, 0x0027,  195, GN_quotesingle },
    ...
    {  58, 0x003a,  273, GN_colon },
    {  59, 0x003b,  273, GN_semicolon },
    {  60, 0x003c,  479, GN_less },
    {  61, 0x003d,  479, GN_equal },
    {  62, 0x003e,  479, GN_greater },
    {  63, 0x003f,  501, GN_question },
    {  64, 0x0040,  800, GN_at },
    {  65, 0x0041,  592, GN_A },
    {  66, 0x0042,  592, GN_B },
    {  67, 0x0043,  592, GN_C },
    ...
    {  89, 0x0059,  547, GN_Y },
    {  90, 0x005a,  501, GN_Z },
    {  91, 0x005b,  273, GN_bracketleft },
    {  92, 0x005c,  228, GN_backslash },
    {  93, 0x005d,  273, GN_bracketright },
    {  94, 0x005e,  479, GN_asciicircum },
    ...
    { 121, 0x0079,  456, GN_y },
    { 122, 0x007a,  410, GN_z },
    { 123, 0x007b,  319, GN_braceleft },
    { 124, 0x007c,  230, GN_bar },
    { 125, 0x007d,  319, GN_braceright },
    ...
    {  -1, 0x00c0,  592, GN_Agrave },
    {  -1, 0x00c1,  592, GN_Aacute },
    {  -1, 0x00c2,  592, GN_Acircumflex },
    {  -1, 0x00c3,  592, GN_Atilde },
    {  -1, 0x00c4,  592, GN_Adieresis },
    {  -1, 0x00c5,  592, GN_Aring },
    ...
    {  -1, 0x00f0,  501, GN_eth },
    {  -1, 0x00f1,  501, GN_ntilde },
    {  -1, 0x00f2,  501, GN_ograve },
    {  -1, 0x00f3,  501, GN_oacute },
    {  -1, 0x00f4,  501, GN_ocircumflex },
    {  -1, 0x00f5,  501, GN_otilde },
    {  -1, 0x00f6,  501, GN_odieresis },
    {  -1, 0x00f7,  479, GN_divide },
    { 249, 0x00f8,  501, GN_oslash },
    {  -1, 0x00f9,  501, GN_ugrave },
    {  -1, 0x00fa,  501, GN_uacute },
    {  -1, 0x00fb,  501, GN_ucircumflex },
    {  -1, 0x00fc,  501, GN_udieresis },
    {  -1, 0x00fd,  456, GN_yacute },
    {  -1, 0x00fe,  501, GN_thorn },
    {  -1, 0x00ff,  456, GN_ydieresis },
    { 245, 0x0131,  228, GN_dotlessi },
    { 232, 0x0141,  501, GN_Lslash },
    { 248, 0x0142,  228, GN_lslash },
    { 234, 0x0152,  820, GN_OE },
    { 250, 0x0153,  774, GN_oe },
    {  -1, 0x0160,  547, GN_Scaron },
    {  -1, 0x0161,  456, GN_scaron },
    ...
    {  96, 0x2018,  228, GN_quoteleft },
    {  39, 0x2019,  228, GN_quoteright },
    { 184, 0x201a,  228, GN_quotesinglbase },
    { 170, 0x201c,  410, GN_quotedblleft },
    { 186, 0x201d,  410, GN_quotedblright },
    { 185, 0x201e,  410, GN_quotedblbase },
    ...
    { 174, 0xfb01,  501, GN_fi },
    { 175, 0xfb02,  501, GN_fl }
};

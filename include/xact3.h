...
/*** IXACT3Cue methods ***/
#define IXACT3Cue_Play(p)               (p)->lpVtbl->Play(p)
...
#else
/*** IXACT3Cue methods ***/
#define IXACT3Cue_Play(p)               (p)->Play()
#define IXACT3Cue_Stop(p,a)             (p)->Stop(a)
#define IXACT3Cue_GetState(p,a)         (p)->GetState(a)
...
#define IXACT3Wave_Play(p)               (p)->lpVtbl->Play(p)
...
#define IXACT3Wave_Play(p)               (p)->Play()
#define IXACT3Wave_Stop(p,a)             (p)->Stop(a)
#define IXACT3Wave_Pause(p,a)            (p)->Pause(a)
#define IXACT3Wave_GetState(p,a)         (p)->GetState(a)
#define IXACT3Wave_SetPitch(p,a)         (p)->SetPitch(a)
...
#define IXACT3WaveBank_GetNumWaves(p,a)    (p)->lpVtbl->GetNumWaves(p,a)

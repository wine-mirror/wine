...
static const DWORD error_map[1144] =
{
    ...
    ERROR_MR_MID_NOT_FOUND,                            /* 4000001c (STATUS_WX86_UNSIMULATE) */
    ERROR_MR_MID_NOT_FOUND,                            /* 4000001d (STATUS_WX86_CONTINUE) */
    ERROR_MR_MID_NOT_FOUND,                            /* 4000001e (STATUS_WX86_SINGLE_STEP) */
    ERROR_MR_MID_NOT_FOUND,                            /* 4000001f (STATUS_WX86_BREAKPOINT) */
    ERROR_MR_MID_NOT_FOUND,                            /* 40000020 (STATUS_WX86_EXCEPTION_CONTINUE) */
    ERROR_MR_MID_NOT_FOUND,                            /* 40000021 (STATUS_WX86_EXCEPTION_LASTCHANCE) */
    ...
    ERROR_MR_MID_NOT_FOUND,                            /* 40000028 (STATUS_WX86_CREATEWX86TIB) */
...
static const struct { ULONG start, end, offset; } table[35] =
{
    { 0x00000001, 0x00000003, 0 },
    { 0x0000003f, 0x0000003f, 3 },
    { 0x00000080, 0x00000080, 4 },
    { 0x000000bf, 0x000000c0, 5 },
    { 0x00000100, 0x00000121, 7 },
    { 0x00010001, 0x00010002, 41 },
    { 0x40000000, 0x4000002c, 43 },
    { 0x40000294, 0x40000294, 88 },
    { 0x40000370, 0x40000370, 89 },
    { 0x40010003, 0x40010009, 90 },
    { 0x40020056, 0x40020056, 97 },
    { 0x400200af, 0x400200af, 98 },
    { 0x80000001, 0x8000002c, 99 },
    { 0x80000288, 0x80000289, 143 },
    { 0x80010001, 0x80010001, 145 },
    { 0x80090300, 0x80090331, 146 },
    { 0x80090347, 0x80090347, 196 },
    { 0x80092010, 0x80092013, 197 },
    { 0x80096004, 0x80096004, 201 },
    { 0x80130001, 0x80130005, 202 },
    { 0xc0000001, 0xc000010e, 207 },
    { 0xc0000117, 0xc000019c, 477 },
    { 0xc0000202, 0xc000030b, 611 },
    { 0xc0000320, 0xc0000322, 877 },
    { 0xc0000350, 0xc000036f, 880 },
    { 0xc0000380, 0xc000038d, 912 },
    { 0xc000042c, 0xc000042c, 926 },
    { 0xc0020001, 0xc0020058, 927 },
    { 0xc0020062, 0xc0020063, 1015 },
    { 0xc0030001, 0xc003000c, 1017 },
    { 0xc0030059, 0xc0030061, 1029 },
    { 0xc00a0001, 0xc00a0018, 1038 },
    { 0xc00a0022, 0xc00a0036, 1062 },
    { 0xc0130001, 0xc0130016, 1083 },
    { 0xc0150001, 0xc0150027, 1105 },
};

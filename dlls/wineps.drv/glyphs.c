/* Adobe Glyph List, generated from https://github.com/adobe-type-tools/agl-aglfn/raw/4036a9ca80a62f64f9de4f7321a9a045ad0ecfd6/glyphlist.txt */
/* DO NOT EDIT!! */

#include "psdrv.h"

const INT PSDRV_AGLbyNameSize = 4281;

const UNICODEGLYPH PSDRV_AGLbyName[4281] =
{
    { 0x0041, "A" },
    { 0x00c6, "AE" },
    { 0x01fc, "AEacute" },
...
const INT PSDRV_AGLbyUVSize = 3680;

const UNICODEGLYPH PSDRV_AGLbyUV[3680] =
{
    { 0x0001, "controlSTX" },
    { 0x0002, "controlSOT" },
    { 0x0003, "controlETX" },

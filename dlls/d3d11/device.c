...
static ULONG STDMETHODCALLTYPE d3d_device_context_state_Release(ID3DDeviceContextState *iface)
{
    ...
    if (!refcount)
    {
        ID3D11Device4_Release(state->device);
        ...
        struct d3d_device *device, D3D_FEATURE_LEVEL feature_level, REFIID emulated_interface)
{
    ...
    state->device = &device->ID3D11Device4_iface;
...
static ULONG STDMETHODCALLTYPE d3d11_command_list_Release(ID3D11CommandList *iface)
{
    ...
    if (!refcount)
    {
        ...
        ID3D11Device4_Release(list->device);
        free(list);
    }
...
static void STDMETHODCALLTYPE d3d11_command_list_GetDevice(ID3D11CommandList *iface, ID3D11Device **device)
{
    ...
    *device = (ID3D11Device *)list->device;
    ID3D11Device4_AddRef(list->device);
}
...
static ULONG STDMETHODCALLTYPE d3d11_device_context_AddRef(ID3D11DeviceContext1 *iface)
{
    ...
    if (refcount == 1)
    {
        ID3D11Device4_AddRef(&context->device->ID3D11Device4_iface);
    }
...
static ULONG STDMETHODCALLTYPE d3d11_device_context_Release(ID3D11DeviceContext1 *iface)
{
    ...
    if (!refcount)
    {
        ID3D11Device4 *device = &context->device->ID3D11Device4_iface;
...
static void STDMETHODCALLTYPE d3d11_device_context_GetDevice(ID3D11DeviceContext1 *iface, ID3D11Device **device)
{
    ...
    *device = (ID3D11Device *)&context->device->ID3D11Device4_iface;
    ID3D11Device_AddRef(*device);
}
        ...
        BOOL restore, ID3D11CommandList **command_list)
{
    ...
    object->refcount = 1;
    object->device = &context->device->ID3D11Device4_iface;
    wined3d_private_store_init(&object->private_store);

    ID3D11Device4_AddRef(object->device);
...
static HRESULT STDMETHODCALLTYPE d3d11_device_QueryInterface(ID3D11Device4 *iface, REFIID iid, void **out)
{
    struct d3d_device *device = impl_from_ID3D11Device4(iface);
    return IUnknown_QueryInterface(device->outer_unk, iid, out);
}

static ULONG STDMETHODCALLTYPE d3d11_device_AddRef(ID3D11Device4 *iface)
{
    struct d3d_device *device = impl_from_ID3D11Device4(iface);
    return IUnknown_AddRef(device->outer_unk);
}

static ULONG STDMETHODCALLTYPE d3d11_device_Release(ID3D11Device4 *iface)
{
    struct d3d_device *device = impl_from_ID3D11Device4(iface);
    return IUnknown_Release(device->outer_unk);
}

static HRESULT STDMETHODCALLTYPE d3d11_device_CreateBuffer(ID3D11Device4 *iface, const D3D11_BUFFER_DESC *desc,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateTexture1D(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateTexture2D(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateTexture3D(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateShaderResourceView(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateUnorderedAccessView(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateRenderTargetView(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDepthStencilView(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateInputLayout(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateVertexShader(ID3D11Device4 *iface, const void *byte_code,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateGeometryShader(ID3D11Device4 *iface, const void *byte_code,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateGeometryShaderWithStreamOutput(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreatePixelShader(ID3D11Device4 *iface, const void *byte_code,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateHullShader(ID3D11Device4 *iface, const void *byte_code,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDomainShader(ID3D11Device4 *iface, const void *byte_code,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateComputeShader(ID3D11Device4 *iface, const void *byte_code,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateClassLinkage(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateBlendState1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateBlendState(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDepthStencilState(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateRasterizerState(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateSamplerState(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateQuery(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreatePredicate(ID3D11Device4 *iface, const D3D11_QUERY_DESC *desc,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateCounter(ID3D11Device4 *iface, const D3D11_COUNTER_DESC *desc,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDeferredContext(ID3D11Device4 *iface, UINT flags,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_OpenSharedResource(ID3D11Device4 *iface, HANDLE resource, REFIID iid,
        void **out)
{
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CheckFormatSupport(ID3D11Device4 *iface, DXGI_FORMAT format,
        UINT *format_support)
{
    struct d3d_device *device = impl_from_ID3D11Device4(iface);
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CheckMultisampleQualityLevels(ID3D11Device4 *iface,
...
static void STDMETHODCALLTYPE d3d11_device_CheckCounterInfo(ID3D11Device4 *iface, D3D11_COUNTER_INFO *info)
{
    FIXME("iface %p, info %p stub!\n", iface, info);
}

static HRESULT STDMETHODCALLTYPE d3d11_device_CheckCounter(ID3D11Device4 *iface, const D3D11_COUNTER_DESC *desc,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CheckFeatureSupport(ID3D11Device4 *iface, D3D11_FEATURE feature,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_GetPrivateData(ID3D11Device4 *iface, REFGUID guid,
        UINT *data_size, void *data)
{
    ...
    if (FAILED(hr = ID3D11Device4_QueryInterface(iface, &IID_IDXGIDevice, (void **)&dxgi_device)))
        return hr;
...
static HRESULT STDMETHODCALLTYPE d3d11_device_SetPrivateData(ID3D11Device4 *iface, REFGUID guid,
        UINT data_size, const void *data)
{
    IDXGIDevice *dxgi_device;
    HRESULT hr;
...
static HRESULT STDMETHODCALLTYPE d3d11_device_SetPrivateDataInterface(ID3D11Device4 *iface, REFGUID guid,
        const IUnknown *data)
{
    IDXGIDevice *dxgi_device;
    HRESULT hr;
...
static D3D_FEATURE_LEVEL STDMETHODCALLTYPE d3d11_device_GetFeatureLevel(ID3D11Device4 *iface)
{
    struct d3d_device *device = impl_from_ID3D11Device4(iface);
...
static UINT STDMETHODCALLTYPE d3d11_device_GetCreationFlags(ID3D11Device4 *iface)
{
    FIXME("iface %p stub!\n", iface);
...
static HRESULT STDMETHODCALLTYPE d3d11_device_GetDeviceRemovedReason(ID3D11Device4 *iface)
{
    WARN("iface %p stub!\n", iface);
...
static void STDMETHODCALLTYPE d3d11_device_GetImmediateContext(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_SetExceptionMode(ID3D11Device4 *iface, UINT flags)
{
...
static UINT STDMETHODCALLTYPE d3d11_device_GetExceptionMode(ID3D11Device4 *iface)
{
    FIXME("iface %p stub!\n", iface);
...
static void STDMETHODCALLTYPE d3d11_device_GetImmediateContext1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDeferredContext1(ID3D11Device4 *iface, UINT flags,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateRasterizerState1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDeviceContextState(ID3D11Device4 *iface, UINT flags,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_OpenSharedResource1(ID3D11Device4 *iface, HANDLE handle,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_OpenSharedResourceByName(ID3D11Device4 *iface, const WCHAR *name,
...
static void STDMETHODCALLTYPE d3d11_device_GetImmediateContext2(ID3D11Device4 *iface,
        ID3D11DeviceContext2 **context)
{
    FIXME("iface %p, context %p stub!\n", iface, context);
}

static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDeferredContext2(ID3D11Device4 *iface,
...
static void STDMETHODCALLTYPE d3d11_device_GetResourceTiling(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CheckMultisampleQualityLevels1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateTexture2D1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateTexture3D1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateRasterizerState2(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateShaderResourceView1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateUnorderedAccessView1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateRenderTargetView1(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_CreateQuery1(ID3D11Device4 *iface,
...
static void STDMETHODCALLTYPE d3d11_device_GetImmediateContext3(ID3D11Device4 *iface,
        ID3D11DeviceContext3 **context)
{
    FIXME("iface %p, context %p stub!\n", iface, context);
}

static HRESULT STDMETHODCALLTYPE d3d11_device_CreateDeferredContext3(ID3D11Device4 *iface,
...
static void STDMETHODCALLTYPE d3d11_device_WriteToSubresource(ID3D11Device4 *iface,
...
static void STDMETHODCALLTYPE d3d11_device_ReadFromSubresource(ID3D11Device4 *iface,
...
static HRESULT STDMETHODCALLTYPE d3d11_device_RegisterDeviceRemovedEvent(ID3D11Device4 *iface,
...
static void STDMETHODCALLTYPE d3d11_device_UnregisterDeviceRemoved(ID3D11Device4 *iface,
        DWORD cookie)
{
    FIXME("iface %p, cookie %#lx stub!\n", iface, cookie);
}

static const struct ID3D11Device4Vtbl d3d11_device_vtbl =
{
    /* IUnknown methods */
...
static HRESULT STDMETHODCALLTYPE d3d_device_inner_QueryInterface(IUnknown *iface, REFIID riid, void **out)
{
    ...
    if (IsEqualGUID(riid, &IID_ID3D11Device4)
    ...
    {
        *out = &device->ID3D11Device4_iface;
    }
        ...
        REFGUID guid, UINT *data_size, void *data)
{
    ...
    return d3d11_device_GetPrivateData(&device->ID3D11Device4_iface, guid, data_size, data);
}
        ...
        REFGUID guid, UINT data_size, const void *data)
{
    ...
    return d3d11_device_SetPrivateData(&device->ID3D11Device4_iface, guid, data_size, data);
}
        ...
        REFGUID guid, const IUnknown *data)
{
    ...
    return d3d11_device_SetPrivateDataInterface(&device->ID3D11Device4_iface, guid, data);
}
        ...
        const D3D10_BLEND_DESC1 *desc, ID3D10BlendState1 **blend_state)
{
    ...
    if (FAILED(hr = d3d11_device_CreateBlendState(&device->ID3D11Device4_iface, (const D3D11_BLEND_DESC *)desc, &object)))
        return hr;
        ...
        DXGI_FORMAT format, UINT *format_support)
{
    ...
    return d3d11_device_CheckFormatSupport(&device->ID3D11Device4_iface, format, format_support);
}
        ...
        DXGI_FORMAT format, UINT sample_count, UINT *quality_level_count)
{
    ...
    return d3d11_device_CheckMultisampleQualityLevels(&device->ID3D11Device4_iface, format,
        ...
        struct wined3d_device *wined3d_device)
{
    ...
    d3d_device_context_state_init(state, device, feature_level,
            device->d3d11_only ? &IID_ID3D11Device4 : &IID_ID3D10Device1);
...
void d3d_device_init(struct d3d_device *device, void *outer_unknown)
{
    ...
    device->ID3D11Device4_iface.lpVtbl = &d3d11_device_vtbl;

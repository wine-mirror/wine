...
FONT 8, "MS Sans Serif"
{
 ...
 PUSHBUTTON "Preklièi", 2, 208, 24, 56, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "&Pomoè", pshHelp, 208, 46, 56, 14, WS_GROUP | WS_TABSTOP
...
FONT 8, "MS Sans Serif"
{
 ...
 PUSHBUTTON "Preklièi", 2, 206, 24, 56, 14, WS_GROUP | WS_TABSTOP
...
FONT 8, "MS Sans Serif"
{
 ...
 RADIOBUTTON "Doloèeni ti&skalnik:", rad2, 16, 50, 80, 12
 ...
 PUSHBUTTON "Preklièi", IDCANCEL, 206, 24, 56, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "&Možnosti ...", psh1, 206, 46, 56, 14, WS_GROUP | WS_TABSTOP
 GROUPBOX "Usmerjenost", grp2, 6, 85, 100, 50, BS_GROUPBOX
 RADIOBUTTON "P&okonèna", rad3, 50, 100, 40, 12
 RADIOBUTTON "L&ežeèa", rad4, 50, 115, 40, 12
...
FONT 8, "MS Sans Serif"
{
    ...
    PUSHBUTTON      "Preklièi",IDCANCEL,218,23,40,14,WS_GROUP | WS_TABSTOP
    PUSHBUTTON      "&Uporabi", psh3,218,40,40,14,WS_GROUP | WS_TABSTOP
    PUSHBUTTON      "&Pomoè" , pshHelp,218,57,40,14,WS_GROUP | WS_TABSTOP
    GROUPBOX        "Uèinki",1072,6,72,84,34,WS_GROUP
    CHECKBOX	    "Pr&eèrtano", chx1, 10,82,50,10, BS_AUTOCHECKBOX | WS_TABSTOP
    CHECKBOX 	    "Po&dèrtano", chx2, 10,94,50,10, BS_AUTOCHECKBOX
...
FONT 8, "MS Sans Serif"
{
 ...
 LTEXT   "&Rdeèa:", 726 /*1094*/,249,126,24,10
 ...
 LTEXT  "&Nasièenost:" ,724 /*1092*/,202,140,22,10
 ...
 PUSHBUTTON "Preklièi", 2, 52, 166, 44, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "&Pomoè", pshHelp,100,166, 44, 14
 PUSHBUTTON "&Dodaj med namešane barve",    712/*1024*/, 152, 166, 142, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "&Mešanje barv >>", 719/*1025*/,   4, 150, 142, 14, WS_GROUP | WS_TABSTOP
...
FONT 8, "MS Sans Serif"
{
 ...
 CHECKBOX "&Razlikovanje malih in velikih èrk", chx2, 4, 42, 64, 12, BS_AUTOCHECKBOX | WS_TABSTOP
 ...
 PUSHBUTTON "Preklièi", IDCANCEL	 , 182, 23, 50, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "&Pomoè", pshHelp	 , 182, 45, 50, 14, WS_GROUP | WS_TABSTOP
}
...
FONT 8, "MS Sans Serif"
{
 ...
 CHECKBOX "&Razlikovanje malih in velikih èrk", chx2, 5, 62, 59, 12, BS_AUTOCHECKBOX | WS_TABSTOP
 ...
 PUSHBUTTON "Preklièi", IDCANCEL	 , 174, 55, 50, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "&Pomoè", pshHelp	 , 174, 75, 50, 14, WS_GROUP | WS_TABSTOP
}
...
FONT 8, "MS Sans Serif"
{
    ...
    PUSHBUTTON      "&Pomoè",  pshHelp,  50, 161, 48,14, WS_GROUP
...
BEGIN
  ...
  AUTORADIOBUTTON "P&okonèna", rad1, 16, 170, 52, 12, BS_AUTORADIOBUTTON
...
FONT 8, "MS Sans Serif"
{
    ...
    PUSHBUTTON		"Preklièi",		 IDCANCEL,222,128,50,14
    PUSHBUTTON		"&Pomoè",		 pshHelp,222,145,50,14
}
...
¹tevila kopij.\nVnesite ¹tevilo med 1 in %d."
    ...
    PD32_PRINTER_STATUS_WAITING           "Èaka; "

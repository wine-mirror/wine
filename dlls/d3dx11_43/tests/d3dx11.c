...
static inline void check_texture3d_desc_values_(uint32_t line, const D3D11_TEXTURE3D_DESC *desc, uint32_t width,
        uint32_t height, uint32_t depth, uint32_t mip_levels, DXGI_FORMAT format, D3D11_USAGE usage,
    ...
    switch (resource_dimension)
    {
        case D3D11_RESOURCE_DIMENSION_TEXTURE2D:
            ...
            check_texture2d_desc_values_(line, &desc_2d, expected_width, expected_height, expected_mip_levels,
                    image->expected_info.ArraySize, image->expected_info.Format, 1, 0, D3D11_USAGE_DEFAULT,
                    D3D11_BIND_SHADER_RESOURCE, 0, image->expected_info.MiscFlags, FALSE);
        ...
        case D3D11_RESOURCE_DIMENSION_TEXTURE3D:
            ...
            check_texture3d_desc_values_(line, &desc_3d, expected_width, expected_height, image->expected_info.Depth,
                    expected_mip_levels, image->expected_info.Format, D3D11_USAGE_DEFAULT, D3D11_BIND_SHADER_RESOURCE,

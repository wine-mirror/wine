                                                       ...
                                                       const int *attribs )
{
    ...
    pbuffer->driver_funcs = display_driver_funcs;
    pbuffer->funcs = funcs;
    pbuffer->width = width;
...
static inline void memory_funcs_init(void)
{
    ...
    memory_funcs.p_wglShareLists = (void *)1; /* never called */

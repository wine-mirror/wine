...
@ stdcall CM_Disconnect_Machine(long) cfgmgr32.CM_Disconnect_Machine
...
@ stdcall CM_Get_Device_ID_ListA(str ptr long long) cfgmgr32.CM_Get_Device_ID_ListA
@ stdcall CM_Get_Device_ID_ListW(wstr ptr long long) cfgmgr32.CM_Get_Device_ID_ListW
@ stdcall CM_Get_Device_ID_List_ExA(str ptr long long ptr) cfgmgr32.CM_Get_Device_ID_List_ExA
@ stdcall CM_Get_Device_ID_List_ExW(wstr ptr long long ptr) cfgmgr32.CM_Get_Device_ID_List_ExW
...
@ stdcall CM_Get_Device_Interface_AliasA(str ptr ptr ptr long) cfgmgr32.CM_Get_Device_Interface_AliasA
@ stdcall CM_Get_Device_Interface_AliasW(wstr ptr ptr ptr long) cfgmgr32.CM_Get_Device_Interface_AliasW
...
@ stdcall CM_Reenumerate_DevNode(ptr long) cfgmgr32.CM_Reenumerate_DevNode
@ stdcall CM_Reenumerate_DevNode_Ex(ptr long ptr) cfgmgr32.CM_Reenumerate_DevNode_Ex
...
@ stdcall CM_Request_Device_EjectA(ptr ptr ptr long long) cfgmgr32.CM_Request_Device_EjectA
@ stdcall CM_Request_Device_EjectW(ptr ptr ptr long long) cfgmgr32.CM_Request_Device_EjectW

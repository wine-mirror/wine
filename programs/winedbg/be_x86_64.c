...
static struct gdb_register be_x86_64_gdb_register_map[] = {
    ...
    REG(NULL,   "fs",     SegFs, 4),
    REG(NULL,   "gs",     SegGs, 4),
    { NULL,     "st0",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 0]), 10, 10},
    { NULL,     "st1",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 1]), 10, 10},
    { NULL,     "st2",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 2]), 10, 10},
    { NULL,     "st3",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 3]), 10, 10},
    { NULL,     "st4",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 4]), 10, 10},
    { NULL,     "st5",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 5]), 10, 10},
    { NULL,     "st6",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 6]), 10, 10},
    { NULL,     "st7",    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 7]), 10, 10},
    REG(NULL,   "fctrl",  u.FltSave.ControlWord, 4),
    REG(NULL,   "fstat",  u.FltSave.StatusWord, 4),
    REG(NULL,   "ftag",   u.FltSave.TagWord, 4),
    REG(NULL,   "fiseg",  u.FltSave.ErrorSelector, 4),
    REG(NULL,   "fioff",  u.FltSave.ErrorOffset, 4),
    REG(NULL,   "foseg",  u.FltSave.DataSelector, 4),
    REG(NULL,   "fooff",  u.FltSave.DataOffset, 4),
    REG(NULL,   "fop",    u.FltSave.ErrorOpcode, 4),

    REG("sse", "xmm0",  u.s.Xmm0, 16),
    REG(NULL,  "xmm1",  u.s.Xmm1, 16),
    REG(NULL,  "xmm2",  u.s.Xmm2, 16),
    REG(NULL,  "xmm3",  u.s.Xmm3, 16),
    REG(NULL,  "xmm4",  u.s.Xmm4, 16),
    REG(NULL,  "xmm5",  u.s.Xmm5, 16),
    REG(NULL,  "xmm6",  u.s.Xmm6, 16),
    REG(NULL,  "xmm7",  u.s.Xmm7, 16),
    REG(NULL,  "xmm8",  u.s.Xmm8, 16),
    REG(NULL,  "xmm9",  u.s.Xmm9, 16),
    REG(NULL,  "xmm10", u.s.Xmm10, 16),
    REG(NULL,  "xmm11", u.s.Xmm11, 16),
    REG(NULL,  "xmm12", u.s.Xmm12, 16),
    REG(NULL,  "xmm13", u.s.Xmm13, 16),
    REG(NULL,  "xmm14", u.s.Xmm14, 16),
    REG(NULL,  "xmm15", u.s.Xmm15, 16),
    REG(NULL,  "mxcsr", u.FltSave.MxCsr, 4),
};

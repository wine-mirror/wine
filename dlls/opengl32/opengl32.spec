@  stdcall glAccum( long float ) wine_glAccum
@  stdcall glAlphaFunc( long float ) wine_glAlphaFunc
...
@  stdcall glBitmap( long long float float float float ptr ) wine_glBitmap
...
@  stdcall glClearAccum( float float float float ) wine_glClearAccum
@  stdcall glClearColor( float float float float ) wine_glClearColor
@  stdcall glClearDepth( double ) wine_glClearDepth
@  stdcall glClearIndex( float ) wine_glClearIndex
...
@  stdcall glColor3f( float float float ) wine_glColor3f
...
@  stdcall glColor4f( float float float float ) wine_glColor4f
...
@  stdcall glEvalCoord1f( float ) wine_glEvalCoord1f
...
@  stdcall glEvalCoord2f( float float ) wine_glEvalCoord2f
...
@  stdcall glFogf( long float ) wine_glFogf
...
@  stdcall glIndexf( float ) wine_glIndexf
...
@  stdcall glLightModelf( long float ) wine_glLightModelf
...
@  stdcall glLightf( long long float ) wine_glLightf
...
@  stdcall glLineWidth( float ) wine_glLineWidth
...
@  stdcall glMap1f( long float float long long ptr ) wine_glMap1f
@  stdcall glMap2d( long double double long long double double long long ptr ) wine_glMap2d
@  stdcall glMap2f( long float float long long float float long long ptr ) wine_glMap2f
@  stdcall glMapGrid1d( long double double ) wine_glMapGrid1d
@  stdcall glMapGrid1f( long float float ) wine_glMapGrid1f
@  stdcall glMapGrid2d( long double double long double double ) wine_glMapGrid2d
@  stdcall glMapGrid2f( long float float long float float ) wine_glMapGrid2f
@  stdcall glMaterialf( long long float ) wine_glMaterialf
...
@  stdcall glNormal3f( float float float ) wine_glNormal3f
...
@  stdcall glPassThrough( float ) wine_glPassThrough
...
@  stdcall glPixelStoref( long float ) wine_glPixelStoref
@  stdcall glPixelStorei( long long ) wine_glPixelStorei
@  stdcall glPixelTransferf( long float ) wine_glPixelTransferf
@  stdcall glPixelTransferi( long long ) wine_glPixelTransferi
@  stdcall glPixelZoom( float float ) wine_glPixelZoom
@  stdcall glPointSize( float ) wine_glPointSize
@  stdcall glPolygonMode( long long ) wine_glPolygonMode
@  stdcall glPolygonOffset( float float ) wine_glPolygonOffset
...
@  stdcall glRasterPos2f( float float ) wine_glRasterPos2f
...
@  stdcall glRasterPos3f( float float float ) wine_glRasterPos3f
...
@  stdcall glRasterPos4f( float float float float ) wine_glRasterPos4f
...
@  stdcall glRectf( float float float float ) wine_glRectf
...
@  stdcall glRotatef( float float float float ) wine_glRotatef
@  stdcall glScaled( double double double ) wine_glScaled
@  stdcall glScalef( float float float ) wine_glScalef
...
@  stdcall glTexCoord1f( float ) wine_glTexCoord1f
...
@  stdcall glTexCoord2f( float float ) wine_glTexCoord2f
...
@  stdcall glTexCoord3f( float float float ) wine_glTexCoord3f
...
@  stdcall glTexCoord4f( float float float float ) wine_glTexCoord4f
...
@  stdcall glTexEnvf( long long float ) wine_glTexEnvf
...
@  stdcall glTexParameterf( long long float ) wine_glTexParameterf
...
@  stdcall glTranslatef( float float float ) wine_glTranslatef
@  stdcall glVertex2d( double double ) wine_glVertex2d
@  stdcall glVertex2dv( ptr ) wine_glVertex2dv
@  stdcall glVertex2f( float float ) wine_glVertex2f
...
@  stdcall glVertex3f( float float float ) wine_glVertex3f
...
@  stdcall glVertex4f( float float float float ) wine_glVertex4f

...
# - symbols exported by the Oct 94 beta version of kernel32.dll
  ...
  1 stdcall -noname -i386 VxDCall0(long) VxDCall
  2 stdcall -noname -i386 VxDCall1(long) VxDCall
  3 stdcall -noname -i386 VxDCall2(long) VxDCall
  4 stdcall -noname -i386 VxDCall3(long) VxDCall
  5 stdcall -noname -i386 VxDCall4(long) VxDCall
  6 stdcall -noname -i386 VxDCall5(long) VxDCall
  7 stdcall -noname -i386 VxDCall6(long) VxDCall
  8 stdcall -noname -i386 VxDCall7(long) VxDCall
  9 stdcall -noname -i386 VxDCall8(long) VxDCall
 ...
 17 stdcall -noname -i386 CommonUnimpStub()
 ...
 38 stdcall -noname -i386 AllocMappedBuffer()
 39 stdcall -noname -i386 FreeMappedBuffer()
 40 stdcall -noname -i386 OT_32ThkLSF()
 41 stdcall -noname ThunkInitLSF(long str long str str)
 42 stdcall -noname -i386 LogApiThkLSF(str)
 43 stdcall -noname ThunkInitLS(long str long str str)
 44 stdcall -noname -i386 LogApiThkSL(str)
 45 stdcall -noname -i386 Common32ThkLS()
 46 stdcall -noname ThunkInitSL(long str long str str)
 47 stdcall -noname -i386 LogCBThkSL(str)
 48 stdcall -noname ReleaseThunkLock(ptr)
 49 stdcall -noname RestoreThunkLock(long)

 51 stdcall -noname -i386 W32S_BackTo32()
 ...
 89 stdcall -noname -i386 FT_PrologPrime()
 90 stdcall -noname -i386 QT_ThunkPrime()

...
@ cdecl -arch=win32 ?_set_se_translator@@YAP6AXIPAU_EXCEPTION_POINTERS@@@ZP6AXI0@Z@Z(ptr) MSVCR90__set_se_translator
@ cdecl -arch=win64 ?_set_se_translator@@YAP6AXIPEAU_EXCEPTION_POINTERS@@@ZP6AXI0@Z@Z(ptr) MSVCR90__set_se_translator
...
@ cdecl -arch=i386 __libm_sse2_asin() msvcrt.__libm_sse2_asin
@ cdecl -arch=i386 __libm_sse2_asinf() msvcrt.__libm_sse2_asinf
@ cdecl -arch=i386 __libm_sse2_atan() msvcrt.__libm_sse2_atan
@ cdecl -arch=i386 __libm_sse2_atan2() msvcrt.__libm_sse2_atan2
@ cdecl -arch=i386 __libm_sse2_atanf() msvcrt.__libm_sse2_atanf
@ cdecl -arch=i386 __libm_sse2_cos() msvcrt.__libm_sse2_cos
@ cdecl -arch=i386 __libm_sse2_cosf() msvcrt.__libm_sse2_cosf
@ cdecl -arch=i386 __libm_sse2_exp() msvcrt.__libm_sse2_exp
@ cdecl -arch=i386 __libm_sse2_expf() msvcrt.__libm_sse2_expf
@ cdecl -arch=i386 __libm_sse2_log() msvcrt.__libm_sse2_log
@ cdecl -arch=i386 __libm_sse2_log10() msvcrt.__libm_sse2_log10
@ cdecl -arch=i386 __libm_sse2_log10f() msvcrt.__libm_sse2_log10f
@ cdecl -arch=i386 __libm_sse2_logf() msvcrt.__libm_sse2_logf
@ cdecl -arch=i386 __libm_sse2_pow() msvcrt.__libm_sse2_pow
@ cdecl -arch=i386 __libm_sse2_powf() msvcrt.__libm_sse2_powf
@ cdecl -arch=i386 __libm_sse2_sin() msvcrt.__libm_sse2_sin
@ cdecl -arch=i386 __libm_sse2_sinf() msvcrt.__libm_sse2_sinf
@ cdecl -arch=i386 __libm_sse2_tan() msvcrt.__libm_sse2_tan
@ cdecl -arch=i386 __libm_sse2_tanf() msvcrt.__libm_sse2_tanf
...
@ cdecl -ret64 _strtoi64_l(str ptr long ptr) msvcrt._strtoi64_l
@ stub _strtol_l
...
@ cdecl _time32(ptr) msvcrt._time32
...
@ cdecl _wfindnext64i32(long ptr) msvcrt._wfindnext64i32
...
@ cdecl -arch=arm,x86_64 acosf(float) msvcrt.acosf
...
@ cdecl -arch=arm,x86_64 asinf(float) msvcrt.asinf
...
@ cdecl -arch=arm,x86_64 ceilf(float) msvcrt.ceilf
@ cdecl clearerr(ptr) msvcrt.clearerr
@ stub clearerr_s
@ cdecl clock() msvcrt.clock
@ cdecl cos(double) msvcrt.cos
@ cdecl cosh(double) msvcrt.cosh
@ cdecl -arch=arm,x86_64 cosf(float) msvcrt.cosf
@ cdecl -arch=arm,x86_64 coshf(float) msvcrt.coshf
...
@ cdecl -arch=arm,x86_64 floorf(float) msvcrt.floorf
@ cdecl fmod(double double) msvcrt.fmod
@ cdecl -arch=arm,x86_64 fmodf(float float) msvcrt.fmodf
...
@ varargs fwprintf_s(ptr wstr) msvcrt.fwprintf_s
...
@ cdecl -arch=arm,x86_64 modff(float ptr) msvcrt.modff
@ cdecl perror(str) msvcrt.perror
@ cdecl pow(double double) msvcrt.pow
@ cdecl -arch=arm,x86_64 powf(float float) msvcrt.powf
...
@ cdecl -arch=arm,x86_64 sinf(float) msvcrt.sinf
@ cdecl -arch=arm,x86_64 sinhf(float) msvcrt.sinhf
@ varargs sprintf(ptr str) msvcrt.sprintf
@ varargs sprintf_s(ptr long str) msvcrt.sprintf_s
@ cdecl sqrt(double) msvcrt.sqrt
@ cdecl -arch=arm,x86_64 sqrtf(float) msvcrt.sqrtf
...
@ cdecl -arch=arm,x86_64 tanf(float) msvcrt.tanf
@ cdecl tanh(double) msvcrt.tanh
@ cdecl -arch=arm,x86_64 tanhf(float) msvcrt.tanhf

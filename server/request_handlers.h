...
C_ASSERT( offsetof(struct get_window_info_reply, pid) == 12 );
C_ASSERT( offsetof(struct get_window_info_reply, tid) == 16 );
C_ASSERT( offsetof(struct get_window_info_reply, is_unicode) == 20 );
C_ASSERT( offsetof(struct get_window_info_reply, dpi_context) == 24 );

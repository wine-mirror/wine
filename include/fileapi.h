...
WINBASEAPI HANDLE WINAPI FindFirstFileNameW(const WCHAR*,DWORD,DWORD*,WCHAR*);
WINBASEAPI BOOL   WINAPI FindNextFileNameW(HANDLE,DWORD*,WCHAR*);
WINBASEAPI DWORD  WINAPI GetTempPath2A(DWORD,LPSTR);
WINBASEAPI DWORD  WINAPI GetTempPath2W(DWORD,LPWSTR);
#define                  GetTempPath2 WINELIB_NAME_AW(GetTempPath2)

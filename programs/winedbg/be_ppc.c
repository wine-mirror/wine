...
static struct gdb_register be_ppc_gdb_register_map[] = {
    ...
    REG(NULL,   "r8",  Gpr8, 4),
    REG(NULL,   "r9",  Gpr9, 4),
    REG(NULL,   "r10", Gpr10, 4),
    REG(NULL,   "r11", Gpr11, 4),
    REG(NULL,   "r12", Gpr12, 4),
    REG(NULL,   "r13", Gpr13, 4),
    REG(NULL,   "r14", Gpr14, 4),
    REG(NULL,   "r15", Gpr15, 4),
    REG(NULL,   "r16", Gpr16, 4),
    REG(NULL,   "r17", Gpr17, 4),
    REG(NULL,   "r18", Gpr18, 4),
    REG(NULL,   "r19", Gpr19, 4),
    REG(NULL,   "r20", Gpr20, 4),
    REG(NULL,   "r21", Gpr21, 4),
    REG(NULL,   "r22", Gpr22, 4),
    REG(NULL,   "r23", Gpr23, 4),
    REG(NULL,   "r24", Gpr24, 4),
    REG(NULL,   "r25", Gpr25, 4),
    REG(NULL,   "r26", Gpr26, 4),
    REG(NULL,   "r27", Gpr27, 4),
    REG(NULL,   "r28", Gpr28, 4),
    REG(NULL,   "r29", Gpr29, 4),
    REG(NULL,   "r30", Gpr30, 4),
    REG(NULL,   "r31", Gpr31, 4),
    REG(NULL,   "pc",  Iar, 4),
    REG(NULL,   "msr", Msr, 4),
    REG(NULL,   "cr",  Cr, 4),
    REG(NULL,   "lr",  Lr, 4),

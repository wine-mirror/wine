...
static const AFMMETRICS metrics[228] =
{
    ...
    {  34, 0x0022,  474, GN_quotedbl },
    {  35, 0x0023,  556, GN_numbersign },
    {  36, 0x0024,  556, GN_dollar },
    {  37, 0x0025,  889, GN_percent },
    {  38, 0x0026,  722, GN_ampersand },
    { 169, 0x0027,  238, GN_quotesingle },

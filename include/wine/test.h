...
static LONG winetest_muted_traces;    /* number of silenced traces */
static LONG winetest_muted_skipped;   /* same as skipped but silent */
static LONG winetest_muted_todo_successes; /* same as todo_successes but silent */

...
@ cdecl -norelay __CxxFrameHandler(ptr ptr ptr ptr) msvcr120.__CxxFrameHandler
@ cdecl -norelay __CxxFrameHandler2(ptr ptr ptr ptr) msvcr120.__CxxFrameHandler2
@ cdecl -norelay __CxxFrameHandler3(ptr ptr ptr ptr) msvcr120.__CxxFrameHandler3
@ stdcall -arch=i386 __CxxLongjmpUnwind(ptr) msvcr120.__CxxLongjmpUnwind
@ cdecl __CxxQueryExceptionSize() msvcr120.__CxxQueryExceptionSize
...
@ cdecl -arch=!i386 _finitef(float) msvcr120._finitef
...
@ cdecl -arch=!i386 _logbf(float) msvcr120._logbf
...
@ cdecl -arch=!i386 acosf(float) msvcr120.acosf
...
@ cdecl -arch=!i386 asinf(float) msvcr120.asinf
...
@ cdecl -arch=!i386 atanf(float) msvcr120.atanf
@ cdecl atan2(double double) msvcr120.atan2
@ cdecl -arch=!i386 atan2f(float float) msvcr120.atan2f
...
@ cdecl -arch=!i386 cosf(float) msvcr120.cosf
@ cdecl cosh(double) msvcr120.cosh
@ cdecl -arch=!i386 coshf(float) msvcr120.coshf
@ stub cpow
@ stub cpowf
@ stub cpowl
@ stub cproj
...
@ cdecl -arch=!i386 expf(float) msvcr120.expf
...
@ cdecl -arch=!i386 floorf(float) msvcr120.floorf
...
@ cdecl -arch=!i386 fmodf(float float) msvcr120.fmodf
...
@ cdecl -ret64 ldiv(long long) msvcr120.ldiv
...
@ cdecl -arch=!i386 logf(float) msvcr120.logf
@ cdecl log10(double) msvcr120.log10
@ cdecl -arch=!i386 log10f(float) msvcr120.log10f
...
@ cdecl longjmp(ptr long) msvcr120.longjmp
...
@ cdecl -arch=!i386 modff(float ptr) msvcr120.modff
...
@ cdecl -arch=!i386 powf(float float) msvcr120.powf
...
@ cdecl -arch=!i386 tanf(float) msvcr120.tanf
@ cdecl tanh(double) msvcr120.tanh
@ cdecl -arch=!i386 tanhf(float) msvcr120.tanhf

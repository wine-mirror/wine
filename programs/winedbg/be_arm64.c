...
static struct gdb_register be_arm64_gdb_register_map[] = {
    REG("core", "x0",   u.s.X0, 8),
    REG(NULL,   "x1",   u.s.X1, 8),
    REG(NULL,   "x2",   u.s.X2, 8),
    REG(NULL,   "x3",   u.s.X3, 8),
    REG(NULL,   "x4",   u.s.X4, 8),
    REG(NULL,   "x5",   u.s.X5, 8),
    REG(NULL,   "x6",   u.s.X6, 8),
    REG(NULL,   "x7",   u.s.X7, 8),
    REG(NULL,   "x8",   u.s.X8, 8),
    REG(NULL,   "x9",   u.s.X9, 8),
    REG(NULL,   "x10",  u.s.X10, 8),
    REG(NULL,   "x11",  u.s.X11, 8),
    REG(NULL,   "x12",  u.s.X12, 8),
    REG(NULL,   "x13",  u.s.X13, 8),
    REG(NULL,   "x14",  u.s.X14, 8),
    REG(NULL,   "x15",  u.s.X15, 8),
    REG(NULL,   "x16",  u.s.X16, 8),
    REG(NULL,   "x17",  u.s.X17, 8),
    REG(NULL,   "x18",  u.s.X18, 8),
    REG(NULL,   "x19",  u.s.X19, 8),
    REG(NULL,   "x20",  u.s.X20, 8),
    REG(NULL,   "x21",  u.s.X21, 8),
    REG(NULL,   "x22",  u.s.X22, 8),
    REG(NULL,   "x23",  u.s.X23, 8),
    REG(NULL,   "x24",  u.s.X24, 8),
    REG(NULL,   "x25",  u.s.X25, 8),
    REG(NULL,   "x26",  u.s.X26, 8),
    REG(NULL,   "x27",  u.s.X27, 8),
    REG(NULL,   "x28",  u.s.X28, 8),
    REG(NULL,   "x29",  u.s.Fp, 8),
    REG(NULL,   "x30",  u.s.Lr, 8),
    REG(NULL,   "sp",   Sp, 8),
    REG(NULL,   "pc",   Pc, 8),

...
Language=KOR
이 경로는  SUBST에서 사용하고 있습니다
.
MessageId=147
SymbolicName=ERROR_IS_JOIN_PATH
Language=KOR
이 경로는 JOIN에서 사용하고 있습니다
.
MessageId=148
...
Language=KOR
DosMuxSemWait의 이벤트 카운터가 올바르지 않습니다
.
MessageId=152
SymbolicName=ERROR_TOO_MANY_MUXWAITERS
Language=KOR
DosMuxSemWait에 너무 많은 대기자가 있습니다
.
MessageId=153
SymbolicName=ERROR_INVALID_LIST_FORMAT
Language=KOR
DosSemMuxWait 목록이 올바르지 않습니다
.
MessageId=154
...
Language=KOR
자동 데이타 세그멘트가 64k를 넘었습니다
.
MessageId=200
SymbolicName=ERROR_RING2SEG_MUST_BE_MOVABLE
Language=KOR
링 2 세그멘트는 반드시 이동이 가능해야 합니다
.
MessageId=201
...
.
MessageId=1022
SymbolicName=ERROR_NOTIFY_KORM_DIR
Language=KOR
...
.
MessageId=1781
SymbolicName=RPC_X_KORM_VALUE_OUT_OF_RANGE
Language=KOR

...
struct d3d_device
{
    ...
    ID3D11Device4 ID3D11Device4_iface;
...
{
    return CONTAINING_RECORD((ID3D11Device4 *)iface, struct d3d_device, ID3D11Device4_iface);
}

static inline struct d3d_device *impl_from_ID3D11Device4(ID3D11Device4 *iface)
{
    return CONTAINING_RECORD(iface, struct d3d_device, ID3D11Device4_iface);
}

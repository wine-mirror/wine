/*
 * Begin compilation controls for Wine headers that use the host address space
 *
...
#error This file is used with msvcrt headers.  It needs to use the ptr32 address space.
#endif

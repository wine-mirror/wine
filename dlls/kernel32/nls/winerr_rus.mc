;
; Copyright 2010 Vitaly Lipatov (Etersoft)
;
...
Language=RUS
Повреждены служебные блоки памяти
.
MessageId=8
...
Language=RUS
Не удаётся выполнить запись
.
MessageId=30
SymbolicName=ERROR_READ_FAULT
Language=RUS
Не удаётся выполнить чтение
.
MessageId=31
...
Language=RUS
Конфликт совместного доступа
.
MessageId=33
SymbolicName=ERROR_LOCK_VIOLATION
Language=RUS
Конфликт блокировки части файла
.
MessageId=34
...
Language=RUS
Исчерпан буфер файлов совместного использования
.
MessageId=38
...
Language=RUS
В сети есть совпадающие названия
.
MessageId=53
...
Language=RUS
Слишком много команд NetBIOS
.
MessageId=57
SymbolicName=ERROR_ADAP_HDW_ERR
Language=RUS
Аппаратная ошибка сетевой карты
.
MessageId=58
SymbolicName=ERROR_BAD_NET_RESP
Language=RUS
Сервер не может выполнить такую операцию
.
MessageId=59
SymbolicName=ERROR_UNEXP_NET_ERR
Language=RUS
Неожиданная сетевая ошибка
.
MessageId=60
SymbolicName=ERROR_BAD_REM_ADAP
Language=RUS
Несовместимая удалённая сетевая карта
.
MessageId=61
...
Language=RUS
Закончилось место для хранения файлов, ожидающих печати
.
MessageId=63
SymbolicName=ERROR_PRINT_CANCELLED
Language=RUS
Вывод на печать отменён
.
MessageId=64
SymbolicName=ERROR_NETNAME_DELETED
Language=RUS
Сетевое имя более не существует
.
MessageId=65
...
Language=RUS
Слишком много сетевых имён
.
MessageId=69
SymbolicName=ERROR_TOO_MANY_SESS
Language=RUS
Слишком много сетевых подключений NetBIOS
.
MessageId=70
SymbolicName=ERROR_SHARING_PAUSED
Language=RUS
Сервер остановлен или перезагружается
.
MessageId=71
SymbolicName=ERROR_REQ_NOT_ACCEP
Language=RUS
Достигнут предел подключений к удалённому компьютеру
.
MessageId=72
...
Language=RUS
Невозможно создать файл или каталог
.
MessageId=83
SymbolicName=ERROR_FAIL_I24
Language=RUS
Ошибка при вызове прерывания Int24
.
MessageId=84
...
Language=RUS
Нет места для запуска процесса
.
MessageId=100
SymbolicName=ERROR_TOO_MANY_SEMAPHORES
Language=RUS
Слишком много семафоров
.
MessageId=101
SymbolicName=ERROR_EXCL_SEM_ALREADY_OWNED
Language=RUS
Эксклюзивный семафор занят другим процессом
.
MessageId=102
...
Language=RUS
Слишком много запросов к семафору
.
MessageId=104
SymbolicName=ERROR_INVALID_AT_INTERRUPT_TIME
Language=RUS
Нельзя обратиться к семафору во время обработки прерывания
.
MessageId=105
SymbolicName=ERROR_SEM_OWNER_DIED
Language=RUS
Владелец семафора не существует
.
MessageId=106
...
Language=RUS
Не удаётся открыть устройство или файл
.
MessageId=111
...
Language=RUS
Нет дискового пространства
.
MessageId=113
SymbolicName=ERROR_NO_MORE_SEARCH_HANDLES
Language=RUS
Нет свободных дескрипторов файлов
.
MessageId=114
...
Language=RUS
Неверный вызов IOCTL
.
MessageId=118
SymbolicName=ERROR_INVALID_VERIFY_SWITCH
Language=RUS
Неверное значение флага VERIFY (проверки записи на диск)
.
MessageId=119
SymbolicName=ERROR_BAD_DRIVER_LEVEL
Language=RUS
Невозможна обработка полученной драйвером команды
.
MessageId=120
...
Language=RUS
Недостачный объём буфера
.
MessageId=123
SymbolicName=ERROR_INVALID_NAME
Language=RUS
Неверное имя файла, каталога или метки тома
.
MessageId=124
...
Language=RUS
Нет дочерних процессов, которые требуется ожидать
.
MessageId=129
SymbolicName=ERROR_CHILD_NOT_COMPLETE
Language=RUS
Дочерний процесс не завершён
.
MessageId=130
SymbolicName=ERROR_DIRECT_ACCESS_HANDLE
Language=RUS
Неверное использование дескриптора файла
.
MessageId=131
SymbolicName=ERROR_NEGATIVE_SEEK
Language=RUS
Отрицательное позиционирование в файле недопустимо
.
MessageId=132
SymbolicName=ERROR_SEEK_ON_DEVICE
Language=RUS
Невозможно позицирование на этом файле
.
MessageId=133
SymbolicName=ERROR_IS_JOIN_TARGET
Language=RUS
Команда JOIN не может быть использована
.
MessageId=134
SymbolicName=ERROR_IS_JOINED
Language=RUS
Диск уже объединён с помощью JOIN
.
MessageId=135
SymbolicName=ERROR_IS_SUBSTED
Language=RUS
Диск уже отображён с помощью SUBST
.
MessageId=136
SymbolicName=ERROR_NOT_JOINED
Language=RUS
Диск не объединён через JOIN
.
MessageId=137
SymbolicName=ERROR_NOT_SUBSTED
Language=RUS
Диск не отображён через SUBST
.
MessageId=138
...
Language=RUS
Путь используется для отображения диска через SUBST
.
MessageId=147
SymbolicName=ERROR_IS_JOIN_PATH
Language=RUS
Путь используется для объединённого диска
.
MessageId=148
...
Language=RUS
Слишком длинная метка тома
.
MessageId=155
SymbolicName=ERROR_TOO_MANY_TCBS
Language=RUS
Слишком много потоков команд TCB
.
MessageId=156
...
Language=RUS
Невозможно заблокировать сегмент
.
MessageId=158
...
Language=RUS
Неверный номер флага
.
MessageId=187
SymbolicName=ERROR_SEM_NOT_FOUND
Language=RUS
Имя семафора не найдено
.
MessageId=188
...
Language=RUS
Неверный номер сигнала
.
MessageId=210
SymbolicName=ERROR_THREAD_1_INACTIVE
Language=RUS
Ошибка установки обработчика сигнала
.
MessageId=212
SymbolicName=ERROR_LOCKED
Language=RUS
Сегмент заблокирован
.
MessageId=214
...
Language=RUS
Сообщение 0x%1 не найдено в файле %2
.
MessageId=487
...
Language=RUS
Операция ввода-вывода прервана
.
MessageId=996
...
Language=RUS
Производится операция ввода-вывода
.
MessageId=998
SymbolicName=ERROR_NOACCESS
Language=RUS
Нет доступа к адресу памяти
.
MessageId=999
SymbolicName=ERROR_SWAPERROR
Language=RUS
Ошибка при подкачке страницы
.
MessageId=1001
...
Language=RUS
Нераспознанная файловая система
.
MessageId=1006
...
Language=RUS
Невозможно переключиться в полноэкранный режим
.
MessageId=1008
...
Language=RUS
Невозможно записать ключ реестра
.
MessageId=1014
...
Language=RUS
Не удалось выполнить чтение или запись файла реестра
.
MessageId=1017
...
.
MessageId=1022
SymbolicName=ERROR_NOTIFY_RUSM_DIR
Language=RUS
...
Language=RUS
Невозможно заблокировать носитель
.
MessageId=1109
SymbolicName=ERROR_UNABLE_TO_UNLOAD_MEDIA
Language=RUS
Невозможно разблокировать носитель
.
MessageId=1110
...
Language=RUS
Инициализация DLL не удалась
.
MessageId=1115
SymbolicName=ERROR_SHUTDOWN_IN_PROGRESS
Language=RUS
Производится выключение системы
.
MessageId=1116
SymbolicName=ERROR_NO_SHUTDOWN_IN_PROGRESS
Language=RUS
Не производится выключение системы
.
MessageId=1117
...
Language=RUS
Требуется более новая версия Windows
.
MessageId=1151
...
Language=RUS
Приложение реального режима выполнения
.
MessageId=1154
...
Language=RUS
Неверное название сетевого ресурса
.
MessageId=1216
...
Language=RUS
Превышен лимит на количество подключений
.
MessageId=1239
...
Language=RUS
Неверное состояние сервера
.
MessageId=1353
SymbolicName=ERROR_INVALID_DOMAIN_STATE
Language=RUS
Неверное состояние домена
.
MessageId=1354
...
.
MessageId=1401
SymbolicName=ERROR_INVALID_MRUS_HANDLE
Language=RUS
Invalid mRUS handle
.
MessageId=1402
...
.
MessageId=1436
SymbolicName=ERROR_CHILD_WINDOW_MRUS
Language=RUS
Child window mRUSs not allowed
.
MessageId=1437
SymbolicName=ERROR_NO_SYSTEM_MRUS
Language=RUS
Window has no system mRUS
.
MessageId=1438
...
.
MessageId=1456
SymbolicName=ERROR_MRUS_ITEM_NOT_FOUND
Language=RUS
MRUS item not found
.
MessageId=1457
...
.
MessageId=1781
SymbolicName=RPC_X_RUSM_VALUE_OUT_OF_RANGE
Language=RUS
RUSmeration value out of range
.
MessageId=1782

...
static void test_SetTrigger_GetTrigger(void)
{
    ...
    hres = ITaskTrigger_SetTrigger(test_trigger, &normal_trigger_state);
    todo_wine ok(hres == E_INVALIDARG, "Expected E_INVALIDARG: 0x%08x\n", hres);
    normal_trigger_state.cbTriggerSize = sizeof(trigger_state) + 1;
    hres = ITaskTrigger_SetTrigger(test_trigger, &normal_trigger_state);
    todo_wine ok(hres == E_INVALIDARG, "Expected E_INVALIDARG: 0x%08x\n", hres);
    ...
    trigger_state.cbTriggerSize = sizeof(trigger_state);
    hres = ITaskTrigger_GetTrigger(test_trigger, &trigger_state);
    todo_wine ok(trigger_state.Reserved1 == 0 && trigger_state.Reserved2 == 0,
    ...
    trigger_state.cbTriggerSize = sizeof(trigger_state);
    hres = ITaskTrigger_GetTrigger(test_trigger, &trigger_state);
    todo_wine ok(trigger_state.wEndYear == 0, "End year should be 0: %d\n",
            trigger_state.wEndYear);
    todo_wine ok(trigger_state.wEndMonth == 200, "End month should be 200: %d\n",
            trigger_state.wEndMonth);
    todo_wine ok(trigger_state.wEndDay == 200, "End day should be 200: %d\n",
    ...
    trigger_state.cbTriggerSize = sizeof(trigger_state);
    hres = ITaskTrigger_GetTrigger(test_trigger, &trigger_state);
    todo_wine ok(trigger_state.wRandomMinutesInterval == 0,

/*
 * self-registerable dll functions for oledb32.dll
 *
...
#define PROGID_CLSID                  0x00000010  /* add a clsid key to the progid */
...
static LONG register_progid(WCHAR const *clsid, char const *progid,
                            char const *curver_progid, char const *name,
                            char const *extra)
{
    LONG res;
    HKEY progid_key;

...
static void test_strftime(void)
{
    const struct {
       ...
       BOOL todo_handler;
        ...
        {"%Oe", "12", { 0, 0, 0, 12, 0, 70, 0, 0, 0 }, TRUE, TRUE},
        {"%H", "23", { 0, 0, 23, 0, 0, 70, 0, 0, 0 }},
        {"%OH", "23", { 0, 0, 23, 0, 0, 70, 0, 0, 0 }, TRUE, TRUE},
        {"%I", "11", { 0, 0, 23, 0, 0, 70, 0, 0, 0 }},
        {"%OI", "11", { 0, 0, 23, 0, 0, 70, 0, 0, 0 }, TRUE, TRUE},
        {"%m", "12", { 0, 0, 0, 0, 11, 70, 0, 0, 0 }},
        {"%Om", "12", { 0, 0, 0, 0, 11, 70, 0, 0, 0 }, TRUE, TRUE},
        {"%M", "42", { 0, 42, 0, 0, 0, 70, 0, 0, 0 }},
        {"%OM", "42", { 0, 42, 0, 0, 0, 70, 0, 0, 0 }, TRUE, TRUE},
        {"%S", "12", { 12, 0, 0, 1, 0, 70, 0, 0, 0 }},
        {"%OS", "12", { 12, 0, 0, 1, 0, 70, 0, 0, 0 }, TRUE, TRUE},
        {"%u", "4", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }},
        {"%Ou", "4", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }, TRUE, TRUE},
        {"%U", "05", { 0, 0, 0, 1, 1, 70, 0, 31, 0 }},
        {"%OU", "05", { 0, 0, 0, 1, 1, 70, 0, 31, 0 }, TRUE, TRUE},
        {"%U", "00", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }},
        {"%OU", "00", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }, TRUE, TRUE},
        {"%V", "05", { 0, 0, 0, 1, 1, 70, 0, 31, 0 }},
        {"%OV", "05", { 0, 0, 0, 1, 1, 70, 0, 31, 0 }, TRUE, TRUE},
        {"%V", "01", { 0, 0, 0, 1, 1, 70, 4, 0, 0 }},
        {"%OV", "01", { 0, 0, 0, 1, 1, 70, 4, 0, 0 }, TRUE, TRUE},
        {"%w", "4", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }},
        {"%Ow", "4", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }, TRUE, TRUE},
        {"%W", "04", { 0, 0, 0, 1, 0, 70, 0, 31, 0 }},
        {"%OW", "04", { 0, 0, 0, 1, 0, 70, 0, 31, 0 }, TRUE, TRUE},
        {"%W", "00", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }},
        {"%OW", "00", { 0, 0, 0, 1, 0, 70, 4, 0, 0 }, TRUE, TRUE},
        {"%y", "70", { 0, 0, 0, 1, 0, 170, 3, 0, 0 }},
        {"%Oy", "70", { 0, 0, 0, 1, 0, 170, 3, 0, 0 }, TRUE, TRUE},
    };
...
static void test_expf(void)
{
    ...
    for(i=0; i<ARRAY_SIZE(tests); i++) {
        ...
        if(isnan(tests[i].exp))
            ...
            ok(compare_float(r, tests[i].exp, 0),

...
#define REG(f,n,r,gs)  {f, n, FIELD_OFFSET(WOW64_CONTEXT, r), sizeof(((WOW64_CONTEXT*)NULL)->r), gs}
...
static struct gdb_register be_i386_gdb_register_map[] = {
    ...
    REG(NULL,   "fs",     SegFs, 4),
    REG(NULL,   "gs",     SegGs, 4),
    { NULL,     "st0",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[ 0]), 10, 10},
    { NULL,     "st1",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[10]), 10, 10},
    { NULL,     "st2",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[20]), 10, 10},
    { NULL,     "st3",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[30]), 10, 10},
    { NULL,     "st4",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[40]), 10, 10},
    { NULL,     "st5",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[50]), 10, 10},
    { NULL,     "st6",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[60]), 10, 10},
    { NULL,     "st7",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[70]), 10, 10},
    { NULL,     "fctrl",  FIELD_OFFSET(WOW64_CONTEXT, FloatSave.ControlWord), 2, 4},
    { NULL,     "fstat",  FIELD_OFFSET(WOW64_CONTEXT, FloatSave.StatusWord), 2, 4},
    { NULL,     "ftag",   FIELD_OFFSET(WOW64_CONTEXT, FloatSave.TagWord), 2, 4},
    { NULL,     "fiseg",  FIELD_OFFSET(WOW64_CONTEXT, FloatSave.ErrorSelector), 2, 4},
    REG(NULL,   "fioff",  FloatSave.ErrorOffset, 4),
    { NULL,     "foseg",  FIELD_OFFSET(WOW64_CONTEXT, FloatSave.DataSelector), 2, 4},
    REG(NULL,   "fooff",  FloatSave.DataOffset, 4),
    { NULL,     "fop",    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.ErrorSelector) + 2, 2, 4},

    { "sse", "xmm0",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[0]), 16, 16},
    { NULL,  "xmm1",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[1]), 16, 16},
    { NULL,  "xmm2",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[2]), 16, 16},
    { NULL,  "xmm3",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[3]), 16, 16},
    { NULL,  "xmm4",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[4]), 16, 16},
    { NULL,  "xmm5",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[5]), 16, 16},
    { NULL,  "xmm6",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[6]), 16, 16},
    { NULL,  "xmm7",  FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, XmmRegisters[7]), 16, 16},
    { NULL,  "mxcsr", FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XMM_SAVE_AREA32, MxCsr), 4, 4},
};

...
Language=NLD
Omgevingsvariable niet gevonden
.
MessageId=205
...
Language=NLD
Bericht 0x%1 niet gevonden in bestand %2
.
MessageId=487
...
Language=NLD
Floppy ID adresteken niet gevonden
.
MessageId=1123
...
Language=NLD
Gebruiker reeds in groep
.
MessageId=1321
SymbolicName=ERROR_MEMBER_NOT_IN_GROUP
Language=NLD
Gebruiker niet in groep
.
MessageId=1322
...
Language=NLD
Protocol sequence niet gevonden
.
MessageId=1745
...
Language=NLD
Reeds aan het wachten op printer handle
.
MessageId=1905
...
Language=NLD
Gebruiker moet zijn wachtwoord wijzigen
.
MessageId=1908

...
FONT 8, "System"
{
 ...
 PUSHBUTTON "ｷｬﾝｾﾙ", 2, 208, 24, 56, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "ﾍﾙﾌﾟ(&H)", 1038, 208, 46, 56, 14, WS_GROUP | WS_TABSTOP
...
FONT 8, "System"
{
 ...
 PUSHBUTTON "ｷｬﾝｾﾙ", 2, 206, 24, 56, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "ﾌﾟﾘﾝﾀの設定(&S)", 1024, 206, 46, 56, 14, WS_GROUP | WS_TABSTOP
 LTEXT "ﾍﾟｰｼﾞから(&F):", 1090, 60, 80, 30, 9
 LTEXT "ﾍﾟｰｼﾞまで(&T):", 1091, 120, 80, 30, 9
...
FONT 8, "System"
{
 ...
 LTEXT "用紙ｻｲｽﾞ(&Z)", 1089, 130, 95, 30, 9
...
FONT 8, "System"
{
    ...
    LTEXT           "ｽﾀｲﾙ(&Y):",1089 ,108,3,44,9
    COMBOBOX        1137,108,13,64,54, CBS_OWNERDRAWFIXED | CBS_HASSTRINGS | CBS_DISABLENOSCROLL |
                    WS_VSCROLL | WS_TABSTOP | CBS_SIMPLE
    LTEXT           "ｻｲｽﾞ(&S):",1090,179,3,30,9
    COMBOBOX        1138,179,13,32,54, CBS_OWNERDRAWFIXED | CBS_HASSTRINGS | CBS_DISABLENOSCROLL |
                    WS_VSCROLL | WS_TABSTOP | CBS_SIMPLE | CBS_SORT
    DEFPUSHBUTTON   "OK",IDOK,218,6,40,14,WS_GROUP
    PUSHBUTTON      "ｷｬﾝｾﾙ",IDCANCEL,218,23,40,14,WS_GROUP
    PUSHBUTTON      "文字飾り(&A)", 1026,218,40,40,14,WS_GROUP
    PUSHBUTTON      "ﾍﾙﾌﾟ(&H)" , 1038,218,57,40,14,WS_GROUP
...
FONT 8, "System"
{
 ...
 PUSHBUTTON "ｷｬﾝｾﾙ", 2, 52, 166, 44, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "ﾍﾙﾌﾟ(&H)", 1038,100,166, 44, 14
...
FONT 8, "System"
{
 ...
 PUSHBUTTON "ｷｬﾝｾﾙ", 2, IDCANCEL, 23, 50, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "ﾍﾙﾌﾟ(&H)", pshHelp, 182, 45, 50, 14, WS_GROUP | WS_TABSTOP
}
...
FONT 8, "System"
{
 ...
 PUSHBUTTON "ｷｬﾝｾﾙ", IDCANCEL, 174, 55, 50, 14, WS_GROUP | WS_TABSTOP
 PUSHBUTTON "ﾍﾙﾌﾟ(&H)", pshHelp, 174, 75, 50, 14, WS_GROUP | WS_TABSTOP
}
...
FONT 8, "System"
{
    ...
    PUSHBUTTON      "ﾍﾙﾌﾟ(&H)",  pshHelp,  50, 161, 48,14, WS_GROUP

    GROUPBOX        "ﾌﾟﾘﾝﾀ",        grp4,   8,  4, 272,84, WS_GROUP
    CONTROL         "ﾌｧｲﾙへ出力(&L)", chx1, "Button",BS_AUTOCHECKBOX | WS_GROUP | WS_TABSTOP,212,70,64,12
    PUSHBUTTON      "ﾌﾟﾛﾊﾟﾃｨ(&P)",    psh2, 212, 17,  60,14, WS_GROUP
    LTEXT           "ﾌﾟﾘﾝﾀ名(&N):",         stc6,  16, 20,  36,8
    ...
    LTEXT           "ｺﾒﾝﾄ:",       stc9,  16, 72,  36,10, SS_NOPREFIX
    ...
    CONTROL         "ﾍﾟｰｼﾞ指定(&G)",         rad3,"Button",BS_AUTORADIOBUTTON,16,122,36,12
    CONTROL         "選択した部分(&S)",     rad2,"Button",BS_AUTORADIOBUTTON,16,138,64,12
    EDITTEXT                          edt1,  74,122,  26,12, WS_GROUP | ES_NUMBER
    EDITTEXT                          edt2, 118,122,  26,12, WS_GROUP | ES_NUMBER
    RTEXT           "ﾍﾟｰｼﾞから(&F)",         stc2,  52,124,  20,8
    RTEXT           "ﾍﾟｰｼﾞまで(&T)",           stc3, 100,124,  16,8
}
...
/*    PUSHBUTTON      "Network...", psh5, 284,156,48,14 */
    ...
    LTEXT           "用紙ｻｲｽﾞ(&Z):",         stc2,  16,108,  36, 8
...
FONT 8, "System"
{
    ...
    LTEXT	"ﾌｧｲﾙ名(&N):",IDC_FILENAMESTATIC,5,112,48,8, SS_NOTIFY
    EDITTEXT	IDC_FILENAME,56,110,153,12,ES_AUTOHSCROLL
    
    LTEXT	"ﾌｧｲﾙの種類(&T):",IDC_FILETYPESTATIC,5,128,52,8, SS_NOTIFY
    COMBOBOX	IDC_FILETYPE,56,126,153,53,CBS_DROPDOWN | WS_VSCROLL | WS_TABSTOP

    CONTROL	"読み取り専用ﾌｧｲﾙとして開く(&R)",IDC_OPENREADONLY,"Button",BS_AUTOCHECKBOX | WS_TABSTOP,54,145,100,10

    DEFPUSHBUTTON	"開く(&O)",		 IDOK,222,110,50,14
    PUSHBUTTON		"ｷｬﾝｾﾙ",		 IDCANCEL,222,128,50,14
    PUSHBUTTON		"ﾍﾙﾌﾟ(&H)",		 pshHelp,222,145,50,14
}
...
STRINGTABLE DISCARDABLE 
{
    ...
    IDS_FILENOTFOUND        "ﾌｧｲﾙが見つかりません。"
    IDS_VERIFYFILE          "ﾌｧｲﾙ名を確認してください。"
    IDS_CREATEFILE          "このﾌｧｲﾙは存在しません。\n作成しますか?"
}

...
@ stdcall -syscall NtAssociateWaitCompletionPacket(ptr ptr ptr ptr ptr long long ptr)
@ stdcall -syscall NtCancelWaitCompletionPacket(ptr long)
@ stdcall -syscall NtCreateWorkerFactory(ptr long ptr ptr ptr ptr ptr long long long)
@ stdcall -syscall NtSetInformationWorkerFactory(ptr long ptr long)
@ stdcall -syscall NtQueryInformationWorkerFactory(ptr long ptr long ptr)
@ stdcall -syscall NtReleaseWorkerFactoryWorker(ptr)
@ stdcall -syscall NtShutdownWorkerFactory(ptr ptr)
@ stdcall -syscall NtWorkerFactoryWorkerReady(ptr)
@ stdcall -syscall NtCreateIRTimer(ptr long)
@ stdcall -syscall NtSetIRTimer(ptr ptr)
